    ...
    >
      ...
      <div className="mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 not-prose">
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-dark mb-2">{CONTENT.persistence.rdb.title}</h3>
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-dark mb-2">{CONTENT.persistence.aof.title}</h3>
      ...
      <AnimateOnScroll>
        <div className="mb-16 bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
          <h3 className="text-2xl font-bold mb-8 text-center text-dark">{CONTENT.chart.title}</h3>
