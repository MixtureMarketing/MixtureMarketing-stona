...
const ServerSideTrackingArticle = () => {
  ...
  return (
    <ArticleShell
      ...
      image={articleData?.image || '/assets/images/server-side-tracking.png'}
      icon={Database}
      accentColor="#3B82F6"
      heroVisual={
        <>
    ...
    >
      ...
      {/* KEY TECHS */}
      <div className="my-24">
        <SectionHeader title={CONTENT.techs.title} subtitle={CONTENT.techs.subtitle} align="left" />
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between text-sm border-b border-gray-100 pb-2">
                  ...
                  <span className="font-bold text-red-500">{CONTENT.caseStudy.before.meta}</span>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-4 rounded-xl text-center">
                    ...
                    <div className="text-xxs text-gray-600 uppercase font-bold">Atrybucja</div>
                  </div>
                  <div className="bg-primary/10 p-4 rounded-xl text-center border border-primary/20">
                    <div className="text-2xl font-black text-secondary">
                      {CONTENT.caseStudy.after.roas}
                    </div>
                    <div className="text-xxs text-gray-600 uppercase font-bold">Wzrost ROAS</div>
                  </div>
                </div>
              </div>
            </div>
