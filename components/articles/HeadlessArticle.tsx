    ...
    <div className="min-h-screen bg-[#F9FAFB] text-dark selection:bg-primary/30 font-sans">
      <Seo
        ...
        description={
          ...
          'Dowiedz się, czym jest Headless WordPress i jak architektura Jamstack poprawia bezpieczeństwo oraz SEO Twojego serwisu.'
        }
            ...
            <div className="my-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-12 not-prose">
                {CONTENT.whatIs.items.map((item, i) => (
                  ...
                  >
                    <div className="text-xxs font-black text-primary uppercase mb-2">
                      {item.label}
                    </div>
      ...
      featuredImage {
        node {
          sourceUrl
            ...
            <RelatedArticles currentArticleId="headless-wordpress" category="tech" />
          </article>
        </div>
      </div>
    </div>
