...
export const FloatingPalette: React.FC<{ delay?: string; className?: string }> = ({
  delay = '0s',
  className = '',
}) => (
  <div
  ...
  >
    <BaseCard
      ...
      padding="none"
      rounded="xl"
      className="bg-white/95 border-pink-100 px-4 py-2.5"
    >
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-black text-gray-400 uppercase leading-none tracking-widest mb-0.5">
            Identity
          </span>
...
export const FloatingUxBadge: React.FC<{ delay?: string; className?: string }> = ({
  delay = '1s',
  className = '',
}) => (
  <div
  ...
  >
    <BaseCard
      ...
      padding="none"
      rounded="xl"
      className="bg-white/95 border-secondary/20 px-4 py-2.5"
    >
      <div className="flex items-center gap-2.5">
...
export const DesignDecorations: React.FC = () => (
  <>
    ...
    <div
      className="absolute bottom-[10%] right-[10%] text-secondary/5 animate-float hidden xl:block pointer-events-none"
