...
export const VISUAL_CONTENT_CONTENT = {
  seo: {
    title: 'Content Wizualny i Social Media | Mixture Marketing',
    description:
      'Projektujemy przyciągający uwagę content wizualny: grafiki social media, rendery 3D i animacje (motion design). Zwiększ zaangażowanie swoich odbiorców.',
    image: '/assets/images/audyt-ux.png',
  },
  hero: {
    badge: 'Content Marketing',
    title: {
      line1: 'Zatrzymaj kciuk',
      line2: 'swojego klienta.',
    },
    description:
      'Wygrywa ten, kto przyciągnie uwagę. Projektujemy "Scroll Stoppers" – grafiki i animacje, które wyróżniają się w gąszczu informacji.',
    cta: 'Strategia Contentu',
    microCopy: 'High Engagement',
  },
  formats: {
    title: 'Formaty, które działają',
    description:
      'Nie wrzucaj byle czego. Każda platforma ma swoją specyfikę. My tworzymy content natywny dla danego medium.',
    items: [
      {
        title: 'Social Media Pack',
        subtitle: 'Instagram / LinkedIn',
        desc: 'Spójne szablony postów, karuzeli i relacji. Budują rozpoznawalność marki w feedzie.',
      },
      {
        title: '3D Product Render',
        subtitle: 'Wizualizacje Produktowe',
        desc: 'Fotorealistyczne rendery produktów w scenerii. Idealne, gdy fizyczny produkt jeszcze nie istnieje.',
      },
      {
        title: 'Motion Graphics',
        subtitle: 'Animacje 2D',
        desc: 'Proste animacje explainer video i animowane logo. Ruch przyciąga uwagę 5x skuteczniej niż statyka.',
      },
    ],
  },
  whyVisuals: {
    title: 'Mózg kupuje obrazem',
    description:
      'Ludzki mózg przetwarza obrazy 60 000 razy szybciej niż tekst. Jeśli Twoja grafika jest słaba, klient przewinie dalej, zanim przeczyta nagłówek.',
    list: [
      'Spójność wizualna buduje zaufanie (Brand Consistency)',
      'Ruch (wideo/animacja) zwiększa konwersję o 80%',
      'Dobre 3D pokazuje produkt lepiej niż zdjęcie',
    ],
    stat: {
      val: '94%',
      label: 'Pierwszego wrażenia zależy od designu',
    },
  },
  cta: {
    title: 'Potrzebujesz contentu na wczoraj?',
    description:
      'Oferujemy pakiety miesięcznej obsługi graficznej. Stały dostęp do grafika bez zatrudniania go na etat.',
    button: 'Zobacz Pakiety Social Media',
  },
};
